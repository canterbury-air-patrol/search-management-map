...
urlpatterns = [
    ...
    url(r'^sector/(?P<id>\d+)/finished/$', views.sector_search_finished, name='sector_search_finished'),
    ...
    url(r'^expandingbox/(?P<id>\d+)/finished/$', views.expanding_box_search_finished, name='expanding_box_search_finished'),
    ...
    url(r'^trackline/(?P<id>\d+)/finished/$', views.track_line_search_finished, name='track_line_search_finished'),
    ...
    url(r'^creepingline/track/(?P<id>\d+)/finished/$', views.creeping_line_track_search_finished, name='creeping_line_track_search_finished'),
