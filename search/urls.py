...
urlpatterns = [
    ...
    re_path(r'^search/(?P<search_id>\d+)/delete/$', views.search_delete, name='search_delete'),
    re_path(r'^search/(?P<search_id>\d+)/details/$', views.search_details, name='search_details'),
