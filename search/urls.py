...
urlpatterns = [
    ...
    url(r'^mission/(?P<mission_id>\d+)/search/creepingline/polygon/incomplete/$', views.search_incomplete, {'search_class': TrackLineCreepingSearch}, name='creeping_line_polygon_search_incomplete'),
    url(r'^mission/(?P<mission_id>\d+)/search/creepingline/polygon/incomplete/kml/$', views.search_incomplete_kml, {'search_class': TrackLineCreepingSearch}, name='creeping_line_polygon_search_incomplete_kml'),
    url(r'^mission/(?P<mission_id>\d+)/search/creepingline/polygon/completed/$', views.search_completed, {'search_class': TrackLineCreepingSearch}, name='creeping_line_polygon_search_completed'),
    url(r'^mission/(?P<mission_id>\d+)/search/creepingline/polygon/completed/kml/$', views.search_completed_kml, {'search_class': TrackLineCreepingSearch}, name='creeping_line_polygon_search_completed_kml'),
