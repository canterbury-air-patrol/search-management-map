...
urlpatterns = [
    ...
    re_path(r'^mission/(?P<mission_id>\d+)/image/(?P<image_id>\d+)/full/$', views.image_get_full, name='image_get_full'),
    re_path(r'^mission/(?P<mission_id>\d+)/image/(?P<image_id>\d+)/thumbnail/$', views.image_get_thumbnail, name='image_get_thumbnail'),
    re_path(r'^mission/(?P<mission_id>\d+)/image/(?P<image_id>\d+)/priority/set/$', views.image_priority_set, name='image_priority_set'),
    re_path(r'^mission/(?P<mission_id>\d+)/image/(?P<image_id>\d+)/priority/unset/$', views.image_priority_unset, name='image_priority_unset'),
