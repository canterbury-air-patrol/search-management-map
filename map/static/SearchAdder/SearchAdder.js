L.SearchAdder = function(map, objectType, objectID) {
    ...
    var searchSelection = "<select id='SearchAdder-search-type-" + RAND_NUM + "'>";
    if (objectType == 'point') {
    ...
    var assetSelection = "<select id='SearchAdder-asset-type-" + RAND_NUM +  "'>";
    ...
    var contents = [
        "Search Type: " + searchSelection + "<br />",
        "Asset Type: " + assetSelection + "<br />",
