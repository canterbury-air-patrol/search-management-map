...
urlpatterns = [
    ...
    re_path(r'^data/pois/(?P<geo_id>\d+)/delete/$', views.point_label_delete, {'geo_type': 'poi'}, name='point_label_delete'),
    re_path(r'^data/pois/(?P<geo_id>\d+)/details/$', views.usergeo_details, {'geo_type': 'poi'}, name='point_label_details'),
    re_path(r'^data/pois/(?P<geo_id>\d+)/json/$', views.usergeo_json, {'geo_type': 'poi'}, name='point_label_json'),
    ...
    re_path(r'^data/userpolygons/(?P<geo_id>\d+)/delete/$', views.user_polygon_delete, {'geo_type': 'polygon'}, name='user_polygon_delete'),
    re_path(r'^data/userpolygons/(?P<geo_id>\d+)/details/$', views.usergeo_details, {'geo_type': 'polygon'}, name='user_polygon_details'),
    re_path(r'^data/userpolygons/(?P<geo_id>\d+)/json/$', views.usergeo_json, {'geo_type': 'polygon'}, name='user_polygon_json'),
